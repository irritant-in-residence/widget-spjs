...
cprequire_test(["inline:com-pymonster-widget-pymonster"], function (sp) {
    ...
    */
    ...
    setTimeout(function() {
        chilipeppr.publish("/com-pymonster-widget-pymonster/requestSingleSelectPort", "");
    }, 2000);
    ...
    */
    ...
    var testProgrammer = function() {
        ...
        $('#com-pymonster-widget-pymonster').append(testProgrammerDiv);
    ...
    var testFro = function() {
        setTimeout(function() {
            chilipeppr.publish("/com-pymonster-widget-pymonster/requestFro", "3.5");
        }, 3000);
    }
    testFro();
    ...
    var testStatus = function() {
        setTimeout(function() {
            chilipeppr.publish("/com-pymonster-widget-pymonster/requestStatus", "3.5");
        }, 6000);
    }
    testStatus();
...
`,
        ...
        init: function (host, buffertype, defaultBaud, buffertypeDescription) {
            ...
            if (buffertype != null && buffertype.length > 0) {
                ...
                $('.com-pymonster-widget-pymonster-bufferindicator').removeClass("hidden").find('.buffername').text(mydescription);
                ...
                if (this.defaultOptions && 'bufferEncouragementMsg' in this.defaultOptions) {
                  $('.com-pymonster-widget-pymonster-bufferindicator').text(
            ...
            if ($.cookie('lasthost')) {
                ...
                $('#com-pymonster-widget-pymonster-host').val(lasthost);
            }
            
            // setup convenience localhost href click
            $('.spjs-connect2localhost').click(function() {
                $('#com-pymonster-widget-pymonster-host').val("localhost");
                that.onRemoteHostConnect();
            });
            $('.spjs-connect2localhostSSL').click(function() {
                $('#com-pymonster-widget-pymonster-host').val("wss://localhost:8990/ws");
                that.onRemoteHostConnect();
            });
            
            // if connect btn or enter key on remote host connect
            var remoteCon = $('#com-pymonster-widget-pymonster-hostbtn');
            remoteCon.click(function() {
                that.onRemoteHostConnect();
            });
            $('#com-pymonster-widget-pymonster-host').keypress(function(event){
            ...
            $('#com-pymonster-widget-pymonster-scanbtn').click(function() {
                var subnet = $('#com-pymonster-widget-pymonster-scan').val();
                that.wsScan(null, subnet);
            });
            
            // cleanup popovers that are getting created by some other widget's code
            //$('.com-pymonster-widget-pymonster').find('.popover').remove();
        ...
        setupSubnetScan: function() {
            ...
            pc.onicecandidate = function(ice){  //listen for candidate events
                ...
                $('#com-pymonster-widget-pymonster-scan').val(subnet);
                pc.onicecandidate = noop;
            };    
        },
        setupRecentServerList: function() {
          var that = this;
        	$('.com-pymonster-widget-pymonster-install .btn-reset-recent-server-list').click(function() {
            localStorage.setItem('com-pymonster-widget-pymonster-serverList', null);
        ...
        showRecentServerList: function() {
          ...
          var elOuter = $('.com-pymonster-widget-pymonster-install .recent-server-list-wrapper');
          var el = $('.com-pymonster-widget-pymonster-install .recent-server-list');
          var that = this;
        ...
        onRequestFro: function(payload) {
            ...
            chilipeppr.publish('/com-pymonster-widget-pymonster/ws/send', 'fro ' + this.singleSelectPort + " " + multiplier + "\n");
        },
        version: null,
        versionFloat: 0.0,
        ...
        onVersion: function(version) {
            ...
            $('.com-pymonster-widget-pymonster .serial-port-version').text(" v" + version + " ");
            
            // Handle functionality buttons show/hidden based on version here
            if ( this.versionFloat >= 1.76) {
                // show restart button
                 $('.com-pymonster-widget-pymonster .btn.spjs-restart').parent().removeClass("hidden");
            } else {
                // hide restart button
                 $('.com-pymonster-widget-pymonster .btn.spjs-restart').parent().addClass("hidden");
            }
            ...
            if ( this.versionFloat >= 1.80) {
                ...
                $('.com-pymonster-widget-pymonster-version-yours').text(version);
                $('.com-pymonster-widget-pymonster-version').addClass('hidden');
                
            } else if (version == "1.6" || version == "1.2" || version == "1.3" || version == "1.3.1" || version == "1.4" || version == "1.5" || version == "snapshot") {
                
                $('.com-pymonster-widget-pymonster-version-yours').text(version);
                //$('.com-pymonster-widget-pymonster-version').addClass('hidden');
                $('.com-pymonster-widget-pymonster-version-fullmsg').html(
                ...
                $('.com-pymonster-widget-pymonster-version-fullmsg .disconnect-inline').click(this.disconnect.bind(this));
                /*
            } else if (version == "1.2") {
                $('.com-pymonster-widget-pymonster-version-fullmsg').html("You are running version 1.2 of the Serial Port JSON Server. If you are running a TinyG, you should upgrade to the new 1.6 version as the Serial Port JSON Server now supports buffer flow control plugins. A plugin has been written for TinyG that puts the control closer to the serial port to ensure no lost Gcode. If you are running an alternate workspace, you're all set, although you could still upgrade.<br/><br/>To upgrade, disconnect from the websocket server and click the correct platform to download the binary for.");
                */
            } else {
                if (version != null && version != "")
                    $('.com-pymonster-widget-pymonster-version-yours').text(version);
                $('.com-pymonster-widget-pymonster-version').removeClass('hidden');
            }
        },
        resetVersion: function() {
            ...
            $('.com-pymonster-widget-pymonster-version-yours').text("1.1");
        ...
        hideVersion: function() {
            $('.com-pymonster-widget-pymonster-version').addClass('hidden');
            $('.com-pymonster-widget-pymonster .panel-heading .serial-port-version').text('');
        },
        resetSpjsName: function() {
            $('.com-pymonster-widget-pymonster .panel-heading .hosttitle').text('');
        },
        onSpjsName: function(spjsName) {
            $('.com-pymonster-widget-pymonster .panel-heading .hosttitle').text(spjsName);
        },
        setupCloudServers: function() {
            
            // make everything clickable
            $('.com-pymonster-widget-pymonster-body .cloud-card').click(this.onCloudServerClick.bind(this));
        ...
        showBufferEncouragement: function() {
            $('.com-pymonster-widget-pymonster-bufferindicator').removeClass('hidden');
        },
        hideBufferEncouragement: function() {
            $('.com-pymonster-widget-pymonster-bufferindicator').addClass('hidden');
        },
        ...
        publishSingleSelectPort: function() {
            ...
            chilipeppr.publish("/com-pymonster-widget-pymonster/recvSingleSelectPort", port);
        },
        onRemoteHostConnect: function() {
            console.log("onRemoteHostConnect");
            var host = $('#com-pymonster-widget-pymonster-host').val();
            $('#com-pymonster-widget-pymonster-hostconnectmsg').html(
                "Trying to connect to " +
                $('#com-pymonster-widget-pymonster-host').val() + "...");
            this.wsConnect(host, function() {
                $('#com-pymonster-widget-pymonster-hostconnectmsg').html("Last connect successful.");
            }, function() {
                $('#com-pymonster-widget-pymonster-hostconnectmsg').html("Failed to connect to host.");
            });
        },
        setSingleSelectMode: function() {
            ...
            $('.com-pymonster-widget-pymonster .panel-heading .subtitle').html('Single Port Mode');            
        ...
        btnBarSetup: function () {
            ...
            /*
            $('.com-pymonster-widget-pymonster .btn').tooltip({
                animation: true,
                delay: 100,
                //container: 'body'
            });
            */
            $('.com-pymonster-widget-pymonster .btn').popover({
                animation: true,
                delay: 100,
                //container: 'body'
            });
            
            $('.com-pymonster-widget-pymonster .btn.refresh').click(function () {
                $('.com-pymonster-widget-pymonster-disconnected .refresh').prop('disabled', true);
                that.getPortList();
            });
            $('#com-pymonster-widget-pymonster-tbar-showhideconsole').click(
                this.consoleToggle.bind(this)
            );
            $('#com-pymonster-widget-pymonster-tbar-showhidestatus').click(
                this.statusToggle.bind(this)
            );
            $('#com-pymonster-widget-pymonster-tbar-refresh').click(function () {
                that.getPortList();
            });
            $('#com-pymonster-widget-pymonster-tbar-reconws').click(function () {
                that.wsConnect();
            });
            $('#com-pymonster-widget-pymonster-tbar-disconws').click(this.disconnect.bind(this));
            $('.com-pymonster-widget-pymonster .btn.disconnect').click(this.disconnect.bind(this));
            
            // the new restart command
            $('.com-pymonster-widget-pymonster .btn.spjs-restart').click(function () {
                that.restartSpjs();
            });
        ...
        disconnect: function() {
            ...
            if (this.conn) {
                this.conn.close();
                $('.com-pymonster-widget-pymonster-install').removeClass('hidden');
            }
        },
        consoleToggle: function() {
            var con = $('.com-pymonster-widget-pymonster-console');
            var coni = $('.com-pymonster-widget-pymonster-consoleinput');
        ...
        statusToggle: function() {
            var stat = $('.com-pymonster-widget-pymonster-status');
        ...
        consoleSetup: function () {
            ...
            var that = this;
            $("#com-pymonster-widget-pymonster-consoleform").submit(function (evt) {
                evt.preventDefault();
                ...
                var msg = $('#com-pymonster-widget-pymonster-consoleform input');
                if (!msg.val()) {
                    return false;
                }
            ...
            $("#com-pymonster-widget-pymonster-consoleform").keydown(function(evt) {
                ...
                if (evt.which == 38) {
                    ...
                    $("#com-pymonster-widget-pymonster-consoleform input").val(that.history[that.historyLastShownIndex]);
                    ...
                    if (that.historyLastShownIndex >= that.history.length) {
                        ...
                        that.historyLastShownIndex = that.history.length;
                        $("#com-pymonster-widget-pymonster-consoleform input").val("");
                        return;
                    }
                    $("#com-pymonster-widget-pymonster-consoleform input").val(that.history[that.historyLastShownIndex]);
                }
        ...
        appendLogOld: function (msg) {
            ...
            if (this.log == null) this.log = $('.com-pymonster-widget-pymonster-console-log');
            var log = this.log;
            var d = log[0];
        ...
        appendLog: function (msg) {
            ...
            if (this.logEls.log == null) {
                ...
                this.logEls.log = $('.com-pymonster-widget-pymonster-console-log pre');
                this.logEls.logOuter = $('.com-pymonster-widget-pymonster-console-log');
            }
        ...
        reconMsgShow: function() {
            $('.com-pymonster-widget-pymonster-disconnected').removeClass('hidden');
            // undisable the reconnect btn
            $('.com-pymonster-widget-pymonster-disconnected .refresh').prop('disabled', false);
        },
        reconMsgHide: function() {
            $('.com-pymonster-widget-pymonster-disconnected').addClass('hidden');
        },
        ...
        wsScan: function (callback, subnet) {
            ...
            if (window["WebSocket"]) {
                ...
                var scancnterr = 0;
                var cnt = $('#com-pymonster-widget-pymonster-scanresultcnt');
                cnt.text("Starting scan of " + subnet + "*");
                $('#com-pymonster-widget-pymonster-scanresult').html("");
                ...
                //for (var ctr = 1; ctr <= 26; ctr++) {
                  ...
                  setTimeout(function() {
                    ...
                    conn.onopen = function (evt) {
                      ...
                      $('#com-pymonster-widget-pymonster-scanresult').append(server);
                      that.el = server;
                      var that2 = this;
                      setTimeout(function() { 
        ...
        serverListSet: function(key, val) {
          ...
          localStorage.setItem("com-pymonster-widget-pymonster-serverList", txt);
          console.log("serverList:", serverList, "txt:", txt);
          },
        serverListGet: function() {
          var serverList = localStorage.getItem("com-pymonster-widget-pymonster-serverList");
        ...
        onPortOpen: function(data) {
            ...
            if (this.isSingleSelectMode) {
                ...
                // hilite this port
                $('.com-pymonster-widget-pymonster-portlist > tbody > tr').removeClass("success");
            ...
            var that = this;
            setTimeout(function() {
                chilipeppr.publish("/com-pymonster-widget-pymonster/jsonSend", {Id:"startup" +  that.configSendCtr++, D:script});
            }, 3000);
        ...
        onPortList: function (portlist) {
            ...
            chilipeppr.publish("/com-pymonster-widget-pymonster/list", portlist);
            ...
            if (portlist.length > 0) {
                $.each(portlist, function (portlistIndex, item) {
                    ...
                    if ('AvailableBufferAlgorithms' in item) {
                        ...
                        availArgsHtml = "<td><select id=\"" + i + "Buffer\" class=\"com-pymonster-widget-pymonster-buffer\" class=\"form-control\">";
                    ...
                    var row = "<tr id=\"" + i + "Row\" class=\"" + rowClass + "\"><td  style=\"cursor:pointer;\">" +
                        ...
                        //"<td>" + 
                        //"<br>" +
                        "<select id=\"" + i + "Baud\" class=\"com-pymonster-widget-pymonster-baud\" class=\"form-control\">" +
                        that.getBaudRates() +
                        "</select>" + 
                        "</td>" +
            ...
            html = htmlFirst + html;
            $('.table.com-pymonster-widget-pymonster-portlist tbody').html(html);
                ...
                if (item.IsOpen) {
                    ...
                    if (that.versionFloat >= 1.4) {
                        ...
                        $('#' + i + "Buffer").parent().append(
                            '<div class="progress hidden com-pymonster-widget-pymonster-progbar">' +
                    ...
                    if (that.isInitting) {
                        chilipeppr.publish("/com-pymonster-widget-pymonster/onportopen", item);
                    }
                }
            ...
            // publish the port list for other listeners
            chilipeppr.publish("/com-pymonster-widget-pymonster/listAfterMetaDataAdded", portlist);
        ...
        hideAllPopovers: function() {
            $('.com-pymonster-widget-pymonster .btn').popover('hide');
        },
        ...
        onWsConnect: function (event) {
            ...
            //$('.com-pymonster-widget-pymonster-install').addClass('hidden');
            ...
            $('a[href=#com-pymonster-widget-pymonster-portstab]').tab('show');
            
            // hide the warning
            $('#com-pymonster-widget-pymonster .spjs-notconnectedwarning').addClass("hidden");
        ...
        onWsDisconnect: function (event) {
            ...
            // show the warning
            $('#com-pymonster-widget-pymonster .spjs-notconnectedwarning').removeClass("hidden");
        ...
        statusWatcher: function () {
            ...
            chilipeppr.subscribe("/" + this.id + "/ws/sys", this, function (msg) {
                $('.com-pymonster-widget-pymonster-status .well.well-sm').text(msg);
            });
        },
        ...
        forkSetup: function () {
            var topCssSelector = '.com-pymonster-widget-pymonster';
