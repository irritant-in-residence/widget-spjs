  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjComPymonsterWidgetPymonster) {
        ...
        console.log("Widget / Serial Port JSON Server just got loaded.", myObjComPymonsterWidgetPymonster);
